...
def ActivateAI():
    ...
    interpreter = tf.lite.Interpreter(model_path="/home/pi/Desktop/ModelForTFLite/model_floating.tflite")
    ...
    Paper (label1): {PaperPercent}%                                                                     Real Number: {label1 * 100}%
    Wood (label2): {WoodPercent}%                                                                      Real Number: {label2 * 100}%
